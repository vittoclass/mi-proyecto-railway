...
import { Camera as CameraIcon, Loader2, Sparkles, FileUp, Save, Users, User, FileIcon, X, Printer, School, AlertTriangle } from "lucide-react"
...
interface StudentGroup {
  ...
  error?: string; // Para mostrar errores de evaluación por estudiante
}
...
export default function LibelIA() {
  ...
  const handleGroupingModeSelect = async (mode: "single" | "multiple") => {
    ...
    try {
        ...
        // No cambiamos de paso, el usuario puede reintentar.
    } finally {
