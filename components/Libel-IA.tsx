...
#### Archivo 3: `components/Libel-IA.tsx` (La Aplicación Completa y Funcional)

Esta es la versión final que incluye toda la lógica avanzada que pediste, con el manejo de errores robusto y la arquitectura correcta para evitar la página en blanco.
