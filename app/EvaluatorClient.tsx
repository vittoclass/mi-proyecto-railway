...
interface RetroalimentacionEstructurada {
  correccion_detallada?: CorreccionDetallada[]; // Opcional para arte/ensayo
...
export default function EvaluatorClient() {
  ...
  const generateReport = (group: StudentGroup) => { /* ... (sin cambios) ... */ };
